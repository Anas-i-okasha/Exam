...
// Update * from users WHERE (name ) VALUES (info@meraki-academy.org)

Q9) What is the query to delete a user that has `info@meraki-academy.org` as an email?

// drop users WHERE (email )  VALUES ('info@meraki-academy.org`')
...
`SELECT * FROM users WHER age (20-330)`;
